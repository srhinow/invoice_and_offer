...
$GLOBALS['TL_LANG']['tl_iao_invoice']['before_text'] = array('Text vor den Positionen','');
$GLOBALS['TL_LANG']['tl_iao_invoice']['before_template'] = array('Text-Template vor den Positionen','');
$GLOBALS['TL_LANG']['tl_iao_invoice']['beforetext_as_template'] = array('als "Rechnung Text vor Positionen" speichern','');
$GLOBALS['TL_LANG']['tl_iao_invoice']['after_text'] = array('Text nach den Positionen','');
$GLOBALS['TL_LANG']['tl_iao_invoice']['after_template'] = array('Text-Template nach den Positionen','');
...
$GLOBALS['TL_LANG']['tl_iao_invoice']['csv_export_email'] = array('Export-E-Mail','Tragen Sie hier eine gültige EmailAdresse ein wenn die CSV-Dateien auch per Email versendet werden sollen.');
